      ...
      <div id="wrapper">
        <div id="pagee" className="clearfix">
          ...
          <main id="main">
            ...
            <section className="slider relative">
              <div className="swiper mySwiper">
                <div className="swiper-wrapper">
                  <div className="slider-home1 relative overflow-hidden swiper-slide">
                    <div className="silider-image">
                      ...
                      />
                      <img
                        src="./assets/images/slide/mask-slide.png"
                        alt="Image"
                        className="mask-slide"
                      />
                      <img
                        src="./assets/images/slide/mask-fly.png"
                        alt="Image"
                        ...
                        <div className="row">
                          <div className="col-lg-8">
                            ...
                            <p className="des text-white mb-45 fadeInDown wow">
                              Welcome to our Print 128 website! We are a
                              professional and reliable printing company that
                              offers a wide range of printing services to
                            </p>
                            <div className="btn-group">
                              <Link to="#" className="btn-main fadeInDown wow">
                              ...
                              <Link to="#" className="btn-w-wa fadeInDown wow">
            ...
            {/* Widget Slider */}
            {/* Widget Select Form */}
            <div className="mt--82 z-index4 relative fadeInUp wow">
              <div className="tf-container">
                <div className="row">
                            ...
                            <div className="search-bar-group">
                              ...
                              <div className="nice-select" tabIndex={0}>
                                ...
                                <ul className="list">
                                  ...
                                  <li data-value="hanoi" className="option">
                                    HaNoi ,Vietnam
                                  </li>
                                  <li data-value="tolyo" className="option">
                                    Tokyo , Janpan
                                  </li>
                            ...
                            <div className="search-bar-group">
                              ...
                              <div className="nice-select" tabIndex={0}>
                                ...
                                <ul className="list">
                                  ...
                                  <li data-value="booking" className="option">
                                    Booking Type
                                  </li>
                                  <li data-value="booking" className="option">
                                    Booking Type
                              ...
                              <div className="search-bar-group relative">
                                ...
                                <div className="nice-select" tabIndex={0}>
                                  ...
                                  <ul className="list">
                                    ...
                                    <li data-value="month1" className="option">
                                      1 Month
                                    </li>
                                    <li data-value="month2" className="option">
                                      2 Month
                                    </li>
                                    <li data-value="month3" className="option">
                                      3 Month
                                    </li>
                                  </ul>
                                </div>
            ...
            {/* Widget Select Form */}
            {/* Widget Aboutus */}
            <section className="about-us pb-150">
              <div className="tf-container">
                <div className="row pt-35">
                  <div className="col-lg-12 flex">
                    ...
                    <p className="client fadeInUp wow">
                    ...
                    <div className="travel-video relative">
                      ...
                      <div className="video-wrap">
                        <a
                          ...
                          className="widget-icon-video widget-videos flex-five z-index3"
                        >
                      ...
                      />
                      <img
                        src="./assets/images/page/enjoy.png"
                        alt="Image"
                        className="mask-enjoy "
                      />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="inner-content-about">
                      <span className="sub-title-heading text-main mb-15 fadeInUp wow">
                        Explore the world
                      </span>
                      <h2 className="title-heading mb-18 fadeInUp wow">
                        Great opportunity for{" "}
                        <span className="text-gray font-yes">adventure</span>{" "}
                        &amp; travels
                      </h2>
                      <p className="des-heading fadeInUp wow">
                      ...
                      <div className="row mt-27 fadeInUp wow">
                        <div className="col-sm-6">
                          <div className="icon-box-style3">
                            ...
                            <h6 className="title mb-10">
                              <Link to="#">Trusted travel guide</Link>
                            </h6>
                            <p className="des">
                              Welcome to our Print 128 wesit! company that
                              offers a wide r
                            </p>
                          </div>
                        </div>
                        <div className="col-sm-6">
                          <div className="icon-box-style3">
                            <div className="icon flex-three">
                              ...
                              >
                                ...
                                <g mask="url(#mask0_40_476)">
                                  <path
                                    d="M20 23.125V38.8281H38.8281V12.2656H34.1406"
                                    stroke="currentColor"
                                    strokeWidth={2}
                                    strokeMiterlimit={10}
                                    strokeLinecap="round"
                                  ...
                                  />
                                  <path
                                    d="M5.85938 12.2656H1.17188V38.8281H20V23.2031"
                                    stroke="currentColor"
                                    strokeWidth={2}
                                    strokeMiterlimit={10}
                                    strokeLinecap="round"
                            ...
                            <h6 className="title mb-10">
                              <Link to="#">Pesonalized Trips</Link>
                            </h6>
                            <p className="des">
                              Welcome to our Print 128 wesit! company that
                              offers a wide r
                  ...
                  <div className="col-lg-12">
                    <div className="center m0-auto w-text-heading">
                      ...
                      <h2 className="title-heading mb-40 fadeInUp wow">
                        ...
                        <span className="text-gray font-yes">Package</span> the
                        world
                      </h2>
                    </div>
            ...
            <section className="relative tf-widget-activities pd-main overflow-hidden">
              <img
                src="./assets/images/page/mask-activiti.png"
                alt="image"
                className="mask-top"
              />
              <img
                src="./assets/images/page/mask-print-2.png"
                alt="image"
              ...
              <div className="tf-container">
                <div className="row z-index3 relative">
                  ...
                  <div className="col-lg-12">
                    <ul
                      className="nav nav-tabs-activities justify-content-center"
                      id="myTablist"
                      role="tablist"
                    >
                      <li className="nav-item" role="presentation">
                      ...
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          id="ab-tab"
                          data-bs-toggle="tab"
                          data-bs-target="#ab-tab-pane"
                          type="button"
                          role="tab"
                          aria-controls="ab-tab-pane"
                          aria-selected="false"
                        >
                          <span className="icon flex-five">
                      ...
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          id="cd-tab"
                          data-bs-toggle="tab"
                          data-bs-target="#cd-tab-pane"
                          type="button"
                          role="tab"
                          aria-controls="cd-tab-pane"
                          aria-selected="false"
                        >
                          <span className="icon flex-five">
                            <svg
                        ...
                        <div className="tabs-activities-content flex">
                          ...
                          <div className="activities-content relative">
                            ...
                            <div className="flex-three btn-wrap-activitis">
                              <Link to="#" className="icon-activitis flex-five">
                                <i className="icon-Vector-21" />
                              </Link>
                              <Link to="#" className="text-white get-start">
                                Get Started Today
                              </Link>
                            </div>
                            <img
            ...
            <section className="offer-package pd-main bg-1 relative">
              <img
                src="./assets/images/page/feature.jpg"
                alt="image"
                className="feature-ofer"
              />
              <div className="tf-container">
                  ...
                  <div className="col-lg-5">
                    <div className="content">
                      <div className="mb-50">
                        ...
                        <h2 className="title-heading mb-32 fadeInUp wow">
                          Amazing Featured Tour
                          <span className="text-gray font-yes ">
                            {" "}
                            Package
                          </span>{" "}
                          the world
                        ...
                        <p className="des-heading fadeInUp wow">
                          Welcome to our Print 128 website! We are a
                          professional company that offers a wide range of
                          printing
                        </p>
                      </div>
                      <div className="inner-content flex-three">
                        ...
                        <p className="font-italic fadeInUp wow">
                          Discover Great{" "}
                          ...
                          <div className="swiper-slide">
                            <div className="tour-listing">
                              ...
                              >
                                ...
                                <img
                                  src="./assets/images/travel-list/15.jpg"
                                  alt="Image Listing"
                                />
                              </a>
                              <div className="tour-listing-content">
            ...
            {/* Widget Offer Package */}
            {/* Widget Counter */}
            <section className="widget-counter relative">
              <img
                src="./assets/images/page/couter-top.png"
                alt="image"
                className="counter-top"
              />
              <img
                src="./assets/images/page/counter-bottom.png"
                alt="image"
                className="counter-bottom"
              />
              <div className="tf-container">
                <div className="row mb-50">
                  <div className="col-lg-9 flex-three cta-wrap">
                    <div className="image fadeInLeft wow">
                      <img src="./assets/images/page/ready.png" alt="Image" />
                    </div>
                    <div className="content">
                      <h2 className="title-call text-white mb-18 fadeInUp wow">
                        Ready to adventure and enjoy natural
                      </h2>
                      <p className="des text-white fadeInUp wow">
                  ...
                  <div className="col-lg-3">
                    <div className="callt-to-action-button text-end fadeInRight wow">
                      <Link to="#" className="get-call">
                        Let,s get started
                      </Link>
                    </div>
                  </div>
                </div>
                <div className="row mb--20em relative z-index3">
                  <div
                    className="col-6 col-lg-3 wow fadeInUp animated "
                    data-wow-delay="0.1s"
                  >
                    <div className="tf-counter center tf-countto">
                      <div className="icon mb-32">
                        <svg
                          width={85}
                          height={78}
                          viewBox="0 0 85 78"
                        ...
                        >
                          <g clipPath="url(#clip0_73_163)">
                            ...
                            />
                            <path
                              d="M7.47058 45.4106H4.98035V47.6742H7.47058V45.4106Z"
                              fill="currentColor"
                            />
                            <path
                              d="M7.47058 49.938H4.98035V52.2016H7.47058V49.938Z"
                              fill="currentColor"
                            />
                            <path
                  ...
                  >
                    <div className="tf-counter center tf-countto">
                      <div className="icon mb-32">
                        ...
                        >
                          <g clipPath="url(#clip0_73_177)">
                            ...
                            >
                              <path
                                d="M0.947388 0.30294H68.0527V67.4082H0.947388V0.30294Z"
                                fill="white"
                              />
                            </mask>
                      ...
                      <div
                        className="number-counter percen"
                        data-to="99.9"
                        data-speed={2000}
                        data-waypoint-active="yes"
                      >
                  ...
                  >
                    ...
                    <div className="destination-content">
                      ...
                      <div className="flex-two btn-destination">
                        <h6 className="title">
                          <Link to="single-destination.html">
                            View all tours
                          </Link>
                        </h6>
                        <a
                  ...
                  <div className="col-lg-12">
                    <div className="adventure-content">
                      <nav className="mb-40 adventure-scroll">
                        <div
                          className="nav nav-justified nav-tabs-adventure"
                          id="nav-tab"
                          role="tablist"
                        >
                          <li
                            className="nav-link flex-three active"
                            id="nav-home-tab"
                            data-bs-toggle="tab"
                            data-bs-target="#nav-hiking"
                            role="tab"
                            aria-controls="nav-hiking"
                            aria-selected="true"
                          >
                          ...
                          <li
                            className="nav-link flex-three"
                            id="nav-river-tab"
                            data-bs-toggle="tab"
                            data-bs-target="#nav-river"
                            role="tab"
                            aria-controls="nav-river"
                            aria-selected="false"
                          >
                          ...
                          <li
                            ...
                            id="nav-animals-tab"
                            data-bs-toggle="tab"
                            data-bs-target="#nav-animals"
                            role="tab"
                            aria-controls="nav-animals"
                            aria-selected="false"
                          >
                          ...
                          <div className="row">
                            <div className="col-6 col-sm-6 col-lg-3">
                              <div className="tf-adventure flex-three mb-43">
                                ...
                                >
                                  <img
                                    src="./assets/images/tour/tour1.jpg"
                                    alt
                                  />
                                </a>
                                <div className="adventure-image">
                                  <span className="tour-ad">(3 Tour)</span>
                                  <h6 className="title-ad">
                                    <Link to="tour-single.html">
                                      Switzerland
                                    </Link>
                                  </h6>
                            ...
                            <div className="col-6 col-sm-6 col-lg-3">
                              <div className="tf-adventure flex-three mb-43">
                                ...
                                >
                                  <img
                                    src="./assets/images/tour/tour2.jpg"
                                    alt
                                  />
                                </a>
                                <div className="adventure-image">
                            ...
                            <div className="col-6 col-sm-6 col-lg-3">
                              <div className="tf-adventure flex-three mb-43">
                                ...
                                >
                                  <img
                                    src="./assets/images/tour/tour3.jpg"
                                    alt
                                  />
                                </a>
                                <div className="adventure-image">
                            ...
                            <div className="col-6 col-sm-6 col-lg-3">
                              <div className="tf-adventure flex-three mb-43">
                                ...
                                >
                                  <img
                                    src="./assets/images/tour/tour4.jpg"
                                    alt
                                  />
                                </a>
                                <div className="adventure-image">
                            ...
                            <div className="col-6 col-sm-6 col-lg-3">
                              <div className="tf-adventure flex-three mb-43">
                                ...
                                >
                                  <img
                                    src="./assets/images/tour/tour5.jpg"
                                    alt
                                  />
                                </a>
                                <div className="adventure-image">
                            ...
                            <div className="col-6 col-sm-6 col-lg-3">
                              <div className="tf-adventure flex-three mb-43">
                                ...
                                >
                                  <img
                                    src="./assets/images/tour/tour6.jpg"
                                    alt
                                  />
                                </a>
                                <div className="adventure-image">
                            ...
                            <div className="col-6 col-sm-6 col-lg-3">
                              <div className="tf-adventure flex-three mb-43">
                                ...
                                >
                                  <img
                                    src="./assets/images/tour/tour7.jpg"
                                    alt
                                  />
                                </a>
                                <div className="adventure-image">
                            ...
                            <div className="col-6 col-sm-6 col-lg-3">
                              <div className="tf-adventure flex-three mb-43">
                                ...
                                >
                                  <img
                                    src="./assets/images/tour/tour8.jpg"
                                    alt
                                  />
                                </a>
                                <div className="adventure-image">
                      ...
                      <div className="swiper testimonial-image">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide avata">
                            <img
                              src="./assets/images/avata/9.jpg"
                              alt="Image Testimonial"
                            />
                          </div>
                          <div className="swiper-slide avata">
                            <img
                              src="./assets/images/avata/7.jpg"
                              alt="Image Testimonial"
                            />
                          </div>
                          <div className="swiper-slide avata">
                            <img
                              src="./assets/images/avata/8.jpg"
                              alt="Image Testimonial"
                            />
                          </div>
                        </div>
                  ...
                  <div className="col-lg-7 content-banner-contact">
                    ...
                    <div className="flex-three">
                      <div className="video-wrap wow fadeInUp animated">
                        <a
                          href="https://www.youtube.com/watch?v=n9LgeoJE4EI"
                          className="widget-icon-video flex-five widget-videos"
                        >
                          <i className="icon-Polygon-4" />
                        </a>
                      </div>
                      <address className="wow fadeInUp animated">
                        Contact us at{" "}
                        <Link to="mailto:@Hooktheme.co"> @Hooktheme.co</Link>
                        <br />
                      </address>
                    </div>
                    <img
                      src="./assets/images/page/vector2.png"
                      alt="image"
                      className="mask-icon-banner"
                    />
                  </div>
                  <div className="col-lg-5">
                  ...
                  <div className="col-lg-12">
                    <div className="center m0-auto w-text-heading">
                      ...
                      <h2 className="title-heading mb-40 wow fadeInUp animated">
                        ...
                        <span className="text-gray font-yes">from</span> the
                        blog
                      </h2>
                    </div>
                  </div>
                ...
                <div className="row">
                  ...
                  >
                    <div className="tf-widget-blog blog-style">
                      <Link to="blog-details.html" className="blog-image">
                      ...
                      <div className="blog-content">
                        ...
                        <p className="des">
                          Business is the activity of making on cing or buying
                          and selling pro
                        </p>
                        <Link to="blog-details.html" className="btn-read-more">
              ...
              <div className="footer-main">
                ...
                <div className="footer-service">
                  ...
                  <ul className="footer-menu">
                    ...
                    <li>
                      <Link to="blog.html">Blog Insights</Link>
                    </li>
                    <li>
                ...
                <div className="footer-gallery">
                  ...
                  <div className="gallery-img">
                    <a
                      href="./assets/images/gallery/gl1.jpg"
                      data-fancybox="gallery"
                    >
                      <img
                        src="./assets/images/gallery/gl1.jpg"
                        alt="image gallery"
                      />
                    </a>
                    <a
                      href="./assets/images/gallery/gl2.jpg"
                      data-fancybox="gallery"
                    >
                      <img
                        src="./assets/images/gallery/gl2.jpg"
                        alt="image gallery"
                      />
                    </a>
                    <a
                      href="./assets/images/gallery/gl3.jpg"
                      data-fancybox="gallery"
                    >
                      <img
                        src="./assets/images/gallery/gl3.jpg"
                        alt="image gallery"
                      />
                    </a>
                    <a
                      href="./assets/images/gallery/gl4.jpg"
                      data-fancybox="gallery"
                    >
                      <img
                        src="./assets/images/gallery/gl4.jpg"
                        alt="image gallery"
                      />
                    </a>
                    <a
                      href="./assets/images/gallery/gl5.jpg"
                      data-fancybox="gallery"
                    >
                      <img
                        src="./assets/images/gallery/gl5.jpg"
                        alt="image gallery"
                      />
                    </a>
                    <a
                      href="./assets/images/gallery/gl6.jpg"
                      data-fancybox="gallery"
                    >
                      <img
                        src="./assets/images/gallery/gl6.jpg"
                        alt="image gallery"
                      />
                    </a>
                  </div>
