  ...
  <div id="wrapper">
    <div id="pagee" className="clearfix">
                        ...
                        <div className="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                          <ul className="navigation clearfix">
                            ...
                            <li className="dropdown2 current"><a href="#">Pages</a>
                              <ul>
                                <li className="current"><a href="about-us.html">About Us</a>
                                </li>
      ...
      <main id="main">
        ...
        {/* Widget About Us */}
        <section className="about-us-h4">
          <div className="tf-container">
            <div className="row">
              <div className="col-md-6">
                <div className="image-about-h4-wrap relative">
                  <div className="image-about-item relative about-wrap-left">
                    <img src="./assets/images/about-us/about-h41.jpg" alt="image" />
                    <img src="./assets/images/page/shape5.1.png" alt="image" className="shape-about-h4" />
                    <span className="quote">25,000 + Customer Worldwide</span>
                  </div>
                  <div className="image-about-item relative about-wrap-right">
                    <img src="./assets/images/about-us/about-h4.jpg" alt="image" />
                    <img src="./assets/images/page/shape5.1.png" alt="image" className="shape-about-h4" />
                  </div>
                  <div className="box-year center">
                    <span className="number">25</span>
                    <p>year of <br /> experience</p>
                  </div>
                </div>
              </div>
              <div className="col-md-6 inner-content-about">
                <div className="mb-30">
                  <span className="sub-title-heading text-main font-yes fs-28-46">Explore the
                    world</span>
                  <h2 className="title-heading mb-18">Great opportunity for <span className="text-gray font-yes">adventure</span> &amp; travels </h2>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="icon-box-style6">
                      <div className="icon relative">
                        <i className="icon-Group2" />
                      </div>
                      <div className="content">
                        <h6 className="title-icon"><a href="#">Trusted travel guide</a></h6>
                        <p className="des-icon">Welcome to our Print 128 wesit!
                    ...
                    <div className="icon-box-style6">
                      <div className="icon relative">
                        <svg width={40} height={40} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <mask id="mask0_214_218" style={{maskType: 'luminance'}} maskUnits="userSpaceOnUse" x={0} y={0} width={40} height={40}>
                          ...
                          <g mask="url(#mask0_214_218)">
                            ...
                            <path d="M19.9999 1.17188C14.6972 1.17188 11.311 6.82758 13.815 11.5017L19.9999 23.0469L26.1848 11.5017C28.6888 6.82758 25.3025 1.17188 19.9999 1.17188Z" stroke="currentColor" strokeWidth={2} strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                      ...
                      <div className="content">
                        <h6 className="title-icon"><a href="#">Pesonalized Trips</a></h6>
                        <p className="des-icon">Welcome to our Print 128 wesit!
                          company that offers a wide r</p>
                      </div>
                    </div>
                ...
                <div className="flex-three btn-wrap-about ">
        ...
        {/* Widget About Us */}
        {/* Widget Video */}
        <section className="widget-video-about">
          <div className="tf-container">
            <div className="row ">
              <div className="col-lg-12">
                <div className="video-h4-widget relative overflow-hidden mb--14em">
                  <div className="video-wrap">
                    <a href="https://www.youtube.com/watch?v=n9LgeoJE4EI" className="video-box flex-five z-index3 relative widget-videos">
        ...
        <section className="top-this-week-about-us  bg-1">
          <div className="tf-container">
            <div className="row">
              <div className="col-lg-12">
                <div className="mb-30 center">
                  <span className="sub-title-heading text-main font-yes fs-28-46">Featured Tour</span>
                  <h2 className="title-heading">Our top this week</h2>
                </div>
              </div>
              <div className="col-lg-12 relative top-this-week-slide">
                <div className="swiper populer-activities overflow-hidden">
                      ...
                      <div className="tour-listing box-sd">
                        ...
                        <div className="tour-listing-content">
                          <span className="map"><i className="icon-Vector4" />United States
                            USA</span>
                          <h3 className="title-tour-list"><a href="tour-single.html">6 nights From
                              Moscow</a>
                          </h3>
          ...
          <div className="tf-container">
            <div className="row al-i-end mb-40">
              <div className="col-md-7">
                <div className>
                  <span className="sub-title-heading text-main fs-28-46 font-yes">Explore the world</span>
                  <h2 className="title-heading">Great opportunity for <br /><span className="text-gray font-yes">adventure</span> &amp; travels</h2>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-sm-6 col-lg-3">
                <div className="tf-icon-box icon-box-style1 relative">
                  ...
                  <div className="content">
                    <h4 className="title-icon"><a href="#">Adventure Plan</a></h4>
                    <p className="des-icon">Pellentesque habitant morbi tristique senectus
                      netus et
                      malesuada fames ac</p>
                    <a href="#" className="icons-link">Booking Now <i className="icon-Path-77287-1" /></a>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 col-lg-3">
                <div className="tf-icon-box icon-box-style1 relative">
                  ...
                  <div className="content">
                    <h4 className="title-icon"><a href="#">Secure Camping</a></h4>
                    <p className="des-icon">Pellentesque habitant morbi tristique senectus
                      netus et
                      malesuada fames ac</p>
                    <a href="#" className="icons-link">Booking Now <i className="icon-Path-77287-1" /></a>
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="tf-icon-box icon-box-style1 relative">
                  ...
                  <div className="content">
                    <h4 className="title-icon"><a href="#">Trailers &amp; RV Sports</a></h4>
                    <p className="des-icon">Pellentesque habitant morbi tristique senectus
                      netus et
                      malesuada fames ac</p>
                    <a href="#" className="icons-link">Booking Now <i className="icon-Path-77287-1" /></a>
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="tf-icon-box icon-box-style1 relative">
                  <div className="icon">
                    <i className="icon-cabin-1" />
                  </div>
                  <div className="content">
                    <h4 className="title-icon"><a href="#">Luxury cabin</a></h4>
                    <p className="des-icon">Pellentesque habitant morbi tristique senectus
                      netus et
                      malesuada fames ac</p>
                    <a href="#" className="icons-link">Booking Now <i className="icon-Path-77287-1" /></a>
                  ...
                  <div className="icon mb-25">
                    <svg width={85} height={78} viewBox="0 0 85 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_73_163)">
                        ...
                        <path d="M54.4991 23.7441L53.6076 21.63L51.2819 22.4403L52.1734 24.5544L54.4991 23.7441Z" fill="currentColor" />
                        <path d="M56.2822 27.9688L55.3907 25.8546L53.0648 26.6649L53.9563 28.7791L56.2822 27.9688Z" fill="currentColor" />
                      </g>
                      <defs>
                        <clipPath id="clip0_73_163">
                          <rect width={85} height="77.2632" fill="white" transform="matrix(-1 0 0 1 85 0)" />
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
                  <div className="number-counter number" data-to={5489} data-speed={2000} data-waypoint-active="yes">5489</div>
                  <span className="line" />
                  <p className="title-counter text-white">Happy <br />Traveller</p>
                </div>
              </div>
              <div className="col-sm-6 col-lg-3">
                <div className="tf-counter center tf-countto">
                  <div className="icon mb-25">
                    <svg width={69} height={68} viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_73_177)">
                        <mask id="mask0_73_177" style={{maskType: 'luminance'}} maskUnits="userSpaceOnUse" x={0} y={0} width={69} height={68}>
                          <path d="M0.947388 0.30294H68.0527V67.4082H0.947388V0.30294Z" fill="white" />
                        </mask>
                        <g mask="url(#mask0_73_177)">
                          <path d="M26.505 2.26924C13.4757 2.26924 2.91333 12.8315 2.91333 25.8609C2.91333 32.2223 5.44315 37.9842 9.53644 42.2273L2.91333 49.4526H26.505C39.5343 49.4526 50.0967 38.8902 50.0967 25.8609C50.0967 12.8315 39.5343 2.26924 26.505 2.26924Z" stroke="currentColor" strokeWidth={3} strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M29.5166 49.2619C30.5896 58.3735 38.3375 65.4424 47.7375 65.4424H66.0866L60.9352 59.8227C64.1191 56.5225 66.0866 52.041 66.0866 47.0933C66.0866 37.6932 59.0178 29.9454 49.9061 28.8724" stroke="currentColor" strokeWidth={3} strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M33.0583 16.3586C30.0046 16.3586 27.2325 18.4469 26.5051 21.2735V21.2734C25.7776 18.4469 23.0054 16.3586 19.9518 16.3586C16.3324 16.3586 13.3986 19.2924 13.3986 22.9118C13.3986 31.1034 26.5051 39.2949 26.5051 39.2949C26.5051 39.2949 39.6115 31.1034 39.6115 22.9118C39.6115 19.2924 36.6777 16.3586 33.0583 16.3586Z" stroke="currentColor" strokeWidth={3} strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                        </g>
                      </g>
                      <defs>
                        <clipPath id="clip0_73_177">
                          <rect width="67.1053" height="67.1053" fill="white" transform="translate(0.947388 0.302734)" />
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
                  <div className="number-counter percen" data-to="99.9" data-speed={2000} data-waypoint-active="yes">99.9</div>
                  <span className="line" />
                  <p className="title-counter text-white">Total Postive<br />Reviews</p>
                </div>
              </div>
              <div className="col-sm-6 col-lg-3">
                <div className="tf-counter center tf-countto">
        ...
        {/* Widget Counter to */}
        {/* Widget Ig post */}
        <section className="instagram-post pd-main relative">
          <div className="tf-container">
            <div className="row relative z-index3">
              <div className="col-lg-12">
                <div className="center mb-40">
                  <span className="sub-title-heading text-second fs-28-46 font-yes">Explore the
                    world</span>
                  <h2 className="title-heading ">Recent instagram Post</h2>
                </div>
              </div>
            </div>
            <div className="row relative z-index3">
              <div className="col-lg-12">
                <div className="instagram-post-grid">
                  <a href="#" className="tf-instagram relative overflow-hidden">
