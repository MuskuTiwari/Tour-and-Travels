                          ...
                          <ul className="navigation clearfix">
                            ...
                            <li className="dropdown2 current"><a href="#">Pages</a>
                              <ul>
                                ...
                                <li className="current"><a href="gallery.html">Gallery</a>
                                </li>
                ...
                <div className="grid-gallery">
                  <div className="item-1">
                    <div className="tf-gallery">
                      ...
                      <a href="./assets/images/gallery/gallery7.jpg" className="btn-gallery flex-five" data-fancybox="gallery">
                  ...
                  <div className="item-2">
                    <div className="tf-gallery">
                      ...
                      <a href="./assets/images/gallery/gallery9.jpg" data-fancybox="gallery" className="btn-gallery flex-five">
                        <i className="icon-Group-14" />
                      </a>
                      <div className="gallery-content">
                        <h4 className="gallery-title text-white mb-10">Discovery Island</h4>
                  ...
                  <div className="item-3">
                    <div className="tf-gallery">
                      ...
                      <a href="./assets/images/gallery/gallery11.jpg" className="btn-gallery flex-five " data-fancybox="gallery">
                        <i className="icon-Group-14" />
                      </a>
                      <div className="gallery-content">
                        <h4 className="gallery-title text-white mb-10">Discovery Island</h4>
                  ...
                  <div className="item-4">
                    <div className="tf-gallery">
                      ...
                      <a href="./assets/images/gallery/gallery8.jpg" className="btn-gallery flex-five" data-fancybox="gallery">
                        <i className="icon-Group-14" />
                      </a>
                      <div className="gallery-content ">
                        <h4 className="gallery-title text-white mb-10">Discovery Island</h4>
                  ...
                  <div className="item-5">
                    <div className="tf-gallery">
                      ...
                      <a href="./assets/images/gallery/gallery10.jpg" className="btn-gallery flex-five" data-fancybox="gallery">
                        <i className="icon-Group-14" />
                      </a>
                      <div className="gallery-content">
                        <h4 className="gallery-title text-white mb-10">Discovery Island</h4>
                  ...
                  <div className="item-6">
                    <div className="tf-gallery">
                      ...
                      <a href="./assets/images/gallery/gallery12.jpg" className="btn-gallery flex-five" data-fancybox="gallery">
                        <i className="icon-Group-14" />
                      </a>
                      <div className="gallery-content">
                        <h4 className="gallery-title text-white mb-10">Discovery Island</h4>
